...
enum {
	...
	RTN_PROHIBIT,		/* Administratively prohibited	*/ //如果路由是这个类型，会触发ICMP ICMP_PKT_FILTERED 报文的发送的, 输出路由的话就发给上层协议，输入路由的话，就发给源地址 refer to fib_props
...
#define RTPROT_STATIC	4	/* Route installed by administrator 静态的，譬如ip route add proto static命令添加的	*/
